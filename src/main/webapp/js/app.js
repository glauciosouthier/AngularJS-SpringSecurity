...
mapModule.service('MapService', function() { this.show= function ($scope) {showMap($scope)};});
...
var exampleApp = angular.module('exampleApp', ['ngRoute', 'ngCookies', 'exampleApp.services','MapModule'])
	.config(
		[ '$routeProvider', '$locationProvider', '$httpProvider', function($routeProvider, $locationProvider, $httpProvider) {
		 ...
		 bootstrap($rootScope, $location, $cookieStore, UserService,DataFactory);
	});



function bootstrap($rootScope, $location, $cookieStore, UserService,DataFactory){
...
function MapController($scope, $location, DataFactory,MapService) {
	/*MapService.show($scope)
	.success(function (result) {
		//$location.path('/');
	})
	.error(function (error) {
    	console.log('Unable to load map data: ' + error.message);
